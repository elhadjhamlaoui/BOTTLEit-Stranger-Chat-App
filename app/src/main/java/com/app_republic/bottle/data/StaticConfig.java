...
public class StaticConfig {
    public static final int REQUEST_CODE_BOTTLE = 2001;
    public static final int REQUEST_CODE_SETTINGS = 2002 ;
    public static final String INTENT_KEY_CHAT_AVATAR = "friend_avatar" ;
